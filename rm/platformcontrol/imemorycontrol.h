...
public:
     ...
     */
    virtual int getMemoryCurrent(std::shared_ptr<App> app) = 0;
     ...
     */
    virtual void setMemoryMin(int minMem, std::shared_ptr<App> app) = 0;
     ...
     */
    virtual int getMemoryMin(std::shared_ptr<App> app) = 0;
     ...
     * \param app the application to limit
     */
    virtual void setMemoryMax(NumericValue maxMem, std::shared_ptr<App> app) = 0;
     ...
     */
    virtual NumericValue getMemoryMax(std::shared_ptr<App> app) = 0;

...
public:
     ...
     */
    virtual void setPidsMax(NumericValue numPids, std::shared_ptr<App> app) = 0;
     ...
     */
    virtual NumericValue getPidsMax(std::shared_ptr<App> app) = 0;
     ...
     */
    virtual NumericValue getPidsCurrent(std::shared_ptr<App> app) = 0;
